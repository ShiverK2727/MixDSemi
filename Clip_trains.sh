...
screen -dmS synfoc-prostate-d6 bash -c "python train_synfoc.py --dataset prostate --lb_domain 6 --lb_num 20 --save_name SynFoC_d6_8000 --gpu 0 --AdamW --model MedSAM --save_model --overwrite --save_img --max_iterations 8000"
...
# U-Net-only 低步数
python train_unet_only.py --dataset prostate --lb_domain 6 --lb_num 20 \
    --save_name UNet_only_d6_8000 --gpu 0 \
    --save_model --overwrite --save_img --max_iterations 8000
