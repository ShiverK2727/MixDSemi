...
def train(args, snapshot_path):
    ...
    for eval_cycle in range(num_eval_cycles):
        ...
        text = ''
        val_dice = test(args, unet_model, test_dataloader, eval_cycle+1, writer, model_name='unet')
        for n, p in enumerate(part):
        ...
        stu_val_dice = test(args, SAM_model, test_dataloader, eval_cycle+1, writer, model_name='SAM')
        text = ''
        for n, p in enumerate(part):
