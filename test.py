...
def main(args, snapshot_path):
    ...
    if args.eval:
        ...
        if args.model == 'unet':
            ...
            model.load_state_dict(torch.load('../model/{}/train/{}/unet_avg_dice_best_model.pth'.format(args.dataset, args.save_name)))
        elif args.model == 'SAM':
            model, img_embedding_size = create_model(model_name='SAM')
            model.load_lora_parameters('../model/{}/train/{}/SAM_avg_dice_best_model.pth'.format(args.dataset, args.save_name))
...
if __name__ == "__main__":
    ...
    args.ckpt = '/app/MixDSemi/ckpt/medsam_vit_b.pth'
    ...
    logging.basicConfig(filename=snapshot_path + f"/log_test_{args.model}.txt", level=logging.INFO,
