...
def main():
    ...
    # 6. 准备绘图：自动排布到多行多列以容纳更多子图
    num_plots = len(text_groups)
    max_cols = 5
    cols = min(max_cols, num_plots) if num_plots > 0 else 1
    ...
    # 8. 保存图像
    output_filename = "clip_response_heatmaps_gscorecam_3.png"
    plt.tight_layout()
